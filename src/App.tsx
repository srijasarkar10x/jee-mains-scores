...
function Home() {
  return (
    <div className="min-h-screen bg-app-bg text-app-ink py-20 px-6 relative">
      ...
      <div className="max-w-xl mx-auto shadow-app bg-app-surface border border-app-border2 rounded-[12px] p-10 text-center animate-[fadeUp_0.4s_ease_both] mt-10">
        ...
        <div className="flex flex-col gap-4">
          <Link to="/january" className="bg-app-surface2 hover:bg-[#e4ded0] transition-colors border border-app-border p-4 rounded-[8px] text-lg font-medium text-app-ink flex justify-between items-center group">
            <span>January 2026 Session</span>
            <span className="text-app-ink3 group-hover:text-app-ink transition-colors">→</span>
          </Link>
          <Link to="/april" className="bg-app-surface2 hover:bg-[#e4ded0] transition-colors border border-app-border p-4 rounded-[8px] text-lg font-medium text-app-ink flex justify-between items-center group">
